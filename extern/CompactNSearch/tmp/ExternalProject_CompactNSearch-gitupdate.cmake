...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref 1.0.0
  WORKING_DIRECTORY "C:/SPlisHSPlasH/extern/CompactNSearch/src/ExternalProject_CompactNSearch"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 1.0.0
  WORKING_DIRECTORY "C:/SPlisHSPlasH/extern/CompactNSearch/src/ExternalProject_CompactNSearch"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/SPlisHSPlasH/extern/CompactNSearch/src/ExternalProject_CompactNSearch/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/SPlisHSPlasH/extern/CompactNSearch/src/ExternalProject_CompactNSearch/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
