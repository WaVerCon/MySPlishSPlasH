...
if("${show_ref_output}" MATCHES "refs/remotes/36f571d27718f8d3fca9cd3344d47f2c3a1e4a09")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "36f571d27718f8d3fca9cd3344d47f2c3a1e4a09")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "36f571d27718f8d3fca9cd3344d47f2c3a1e4a09")
endif()
